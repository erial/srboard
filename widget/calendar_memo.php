...
var calmon = '';
<?php if($mbr_level >= $editable_level) {?>
if(<?php echo $mbr_level?> >= parseInt(level)) calmon = tht.getElementsByTagName('a')[0].innerHTML.replace(/∼/g,"\n").replace(/∥/g,"\n---\n");
<?php }?>
px = x;py =y;
calmon = "<fieldset id='calmwrte'><div title='이동' onmousedown='calmwmove(1)' onmouseup='calmwmove()'>" + $('mnth').value.substr(4) + "월 "+ dd+ "일</div><textarea cols='1' rows='1'>" + calmon + "</textarea><br />";
...
$('calmemosel').value = "<?php echo $mnth?>";
//]]>
</script></div>
...
<tr class='navi'><td><input type='hidden' id='mnth' value='<?php echo $mnth?>' /></td><td><a href='#none' onclick="calmm('<?php echo $pxm?>')">&lt;</a></td><td colspan='3'><?php echo substr($mnth, 0, 4)?> : <?php echo (int)substr($mnth, 4, 2)?></td><td><a href='#none' onclick="calmm('<?php echo $nxm?>')">&gt;</a></td><td>&nbsp;</td></tr>

...
<tr><td class='mkcell'>
<div id='marker' style='height:12px;overflow:hidden' onmouseover='clearTimeout(changemk)' onmouseout='changemk = setTimeout("chmarker()",1000)'><div style='line-height:20px;margin-top:20px'><?php
...
$('markr').value = '';
$('marker').firstChild.innerHTML = "<b><?php echo $_SESSION['m_nick']?></b> :: " + nkfval + "<br />" + $('marker').firstChild.innerHTML;

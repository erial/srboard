...
$rurl = "<div class='lnkrp'><a target='_blank' href='{$index}?id={$mid}&amp;rp_view={$no}'>{$nrp}</a></div>";
...
?>
<div class='nobf' style='max-width:<?php echo ($wtdh - $wdtt -10)?>px'><span><?php echo $datte?></span>
<?php echo $url?></a></div><?php echo $rurl?>
<div class='fcler'></div>
<?php
} else {

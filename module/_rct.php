...
<div class='menu20 hslice' id='m20_<?php echo $rctid?>'>
<div class='menu25'><div class='menu_title menuone entry-title' onclick="resize_n('resizhgt_<?php echo $rctid?>')"><?php echo $rctname?></div></div>
<div class='menu60'><div id='resizhgt_<?php echo $rctid?>' class='menu40 entry-content'>
<?php
